    ...
    <div className="p-8">
      <div className="max-w-3xl space-y-6">
        ...
        {isLoading ? (
          ...
          <CompanyProfileForm
            key={profile?.id || "company-profile-form"}
...
function CompanyProfileForm({ initialProfile, isSaving, onSubmit }) {
  const [form, setForm] = useState({
    name: initialProfile?.name || "",
    official_email: initialProfile?.official_email || "",
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-3xl border border-slate-200 bg-white p-6 space-y-4">
      <input
